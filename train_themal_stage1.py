    ...
    for iteration in range(1, opt.iterations + 1): 
        ...
        if pipe.brdf:
            ...
            if dataset.static_gspara:
                gaussians.set_requires_grad("opacity", state=iteration <= opt.iterations //2 )
                gaussians.set_requires_grad("scaling", state=iteration <= opt.iterations //2 )
                gaussians.set_requires_grad("rotation", state=iteration <= opt.iterations //2 )
