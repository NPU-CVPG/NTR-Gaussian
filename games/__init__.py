...
from games.mesh_time_splatting.scene.gaussian_mesh_time_model import GaussianMeshTimeModel
...
optimizationParamTypeCallbacks = {
    ...
    "gs_mesh_time": OptimizationParamsMesh,
...
gaussianModel = {
    ...
    "gs_mesh_time": GaussianMeshTimeModel,
